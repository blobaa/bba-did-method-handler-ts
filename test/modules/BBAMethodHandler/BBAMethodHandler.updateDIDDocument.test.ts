...
import { BBAMethodHandler, Error, ErrorCode, UpdateDIDDocumentParams } from "../../../src/index";
...
if (config.test.updateDIDDocument) {
    describe("BBAMethodHandler updateDIDDocument method tests", () => {
        ...
        test("updateDIDDocument success", async () => {
            ...
            const testHandler = new BBAMethodHandler(new RequestMock(setAccountPropertyCallback, uploadTaggedDataCallback, getTransactionCallback ));
